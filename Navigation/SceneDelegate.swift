...
//    var mainCoordinator:
    ...
    func scene(_ scene: UIScene, willConnectTo session: UISceneSession, options connectionOptions: UIScene.ConnectionOptions) {
        ...
        self.appConfiguration = AppConfiguration.randomConfig()
        NetworkManager.request(for: AppConfiguration.randomConfig()) { messegeText in
            print("****\(String(describing: messegeText))")
        }
